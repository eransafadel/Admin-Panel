...
const FeaturedInfoBuilder = ({item}) => {
    const {featuredTitle,featuredMoney,featuredMoneyRate,Icon,featuredSub} = item;
  return (
    ...
    <div className="featuredMoneyContainer">
        ...
        <span className="featuredMoneyRate">
            {featuredMoneyRate} <Icon className={`featuredIcon ${featuredMoneyRate>0?'positive':'negative'}`}/>
        </span>            
    </div>
